"""convertire lapp in modo da avere delle chiamate a servizi rest e restituiscono un json postman postman o su brownswer a video
...
db_config = {
    "host": "172.18.177.17",  # Cambio con l'indirizzo IP della macchina
    "port": "5432",
    "dbname": "accademia",
    "user": "postgres",
    "password": "postgres"
